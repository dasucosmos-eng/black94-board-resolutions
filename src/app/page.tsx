...
You MUST respond with ONLY valid JSON (no markdown, no code blocks, no extra text). The JSON must have exactly these fields:
{
  ...
  "resolvedText": "The full RESOLVED THAT text with formal legal language. Write 3-5 detailed sentences. Start with RESOLVED THAT, and include all specific details like bank names, amounts, people, dates, account types from the description. Use formal corporate language like hereby approves, subject to applicable laws.",
